...
export const individualSeventeenPlus = [
    ...
    { po: '1d6x1000', pl: '1d6x100' },
    { po: '1d6x1000', pl: '2d6x100' }
];
export const hoardZeroFour = [
    ...
    { gemArt: '2d6x10gems', magicItems: '1d6xMagItemB' },
    { gemArt: '2d4x25art', magicItems: '1d6xMagItemB' },
    { gemArt: '2d6x50gems', magicItems: '1d6xMagItemB' },
    { gemArt: '2d6x10gems', magicItems: '1d6xMagItemC' },
    { gemArt: '2d4x25art', magicItems: '1d6xMagItemC' },
    { gemArt: '2d6x50gems', magicItems: '1d6xMagItemC' },
    { gemArt: '2d4x25art', magicItems: '1d6xMagItemF' },
    { gemArt: '2d6x50gems', magicItems: '1d6xMagItemF' },
    { gemArt: '2d4x25art', magicItems: '1d6xMagItemG' },
...
export const hoardFiveTen = [
    ...
    { gemArt: '2d4x250art', magicItems: '1d6xMagItemA' },
    { gemArt: '2d4x25art', magicItems: '1d4xMagItemB' },
    { gemArt: '3d6x50gems', magicItems: '1d4xMagItemB' },
    { gemArt: '3d6x100gems', magicItems: '1d4xMagItemB' },
    { gemArt: '2d4x250art', magicItems: '1d4xMagItemB' },
    { gemArt: '2d4x25art', magicItems: '1d4xMagItemC' },
    { gemArt: '3d6x50gems', magicItems: '1d4xMagItemC' },
    { gemArt: '3d6x100gems', magicItems: '1d4xMagItemC' },
    { gemArt: '2d4x250art', magicItems: '1d4xMagItemC' },
    { gemArt: '2d4x25art', magicItems: '1d1xMagItemD' },
    { gemArt: '3d6x50gems', magicItems: '1d1xMagItemD' },
    { gemArt: '3d6x100gems', magicItems: '1d1xMagItemD' },
    { gemArt: '2d4x250art', magicItems: '1d1xMagItemD' },
    { gemArt: '2d4x25art', magicItems: '1d4xMagItemF' },
    { gemArt: '3d6x50gems', magicItems: '1d4xMagItemF' },
    { gemArt: '3d6x100gems', magicItems: '1d4xMagItemF' },
    { gemArt: '2d4x250art', magicItems: '1d4xMagItemF' },
    { gemArt: '3d6x100gems', magicItems: '1d4xMagItemG' },
    { gemArt: '2d4x250art', magicItems: '1d6xMagItemG' },
    { gemArt: '3d6x100gems', magicItems: '1d1xMagItemH' },
...
export const hoardElevenSixteen = [
    ...
    { gemArt: '3d6x1000gems', magicItems: '1d6xMagItemC' },
    { gemArt: '2d4x250art', magicItems: '1d4xMagItemD' },
